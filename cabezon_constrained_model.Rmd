...
ccf_age0   <- ccf_boot(ss_dln_fy_combined_obs$larvae_index,
                       ss_dln_fy_combined_obs$age0,
                       lag.max = 10, plot = "Spearman", B = 1000)
ccf_recdev <- ccf_boot(ss_dln_fy_combined_obs$larvae_index,
                       ss_dln_fy_combined_obs$rec_dev,
                       lag.max = 10, plot = "Spearman", B = 1000)
ccf_ssb    <- ccf_boot(ss_dln_fy_combined_obs$larvae_index,
                       ss_dln_fy_combined_obs$ssb,
                       lag.max = 10, plot = "Spearman", B = 1000)
ccf_dssb   <- ccf_boot(diff(ss_dln_fy_combined_obs$larvae_index),
                       diff(ss_dln_fy_combined_obs$ssb),
                       lag.max = 10, plot = "Spearman", B = 1000)
