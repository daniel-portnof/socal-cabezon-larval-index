...
ggplot() +
  ...
  labs(
    title = "Observed cabezon larval abundance by CalCOFI station",
    subtitle = "Mean density from positive tows only, aggregated by station",
    x = NULL,
    y = NULL
  ) +
  theme_minimal()
...
```{r combined prediction + observation plots}
library(sf)
library(dplyr)
library(ggplot2)
library(rnaturalearth)
...
ggsave(
  "C:/Users/machs/SynologyDrive/Dan's Files/SIO/0_capstone/6_figures/p_obs_poster.png",
  plot = p_obs,
  width = 9,
  height = 7,
  units = "in",
...
ggsave(
  "C:/Users/machs/SynologyDrive/Dan's Files/SIO/0_capstone/6_figures/p_model_poster_rocket.png",
  plot = p_model,
  width = 9,
  height = 7,
  units = "in",
...
#ggsave(
#  "figures/obs_model_side_by_side.png",
#  p_obs + p_model + plot_layout(widths = c(1, 1)),
#  width = 14,
#  height = 7,
#  units = "in",
#  dpi = 300
