...
ggsave("C:/Users/machs/SynologyDrive/Dan's Files/SIO/0_capstone/6_figures/partial_effects_paper.png", partial_effects,
       width = 8, height = 4, units = "in", dpi = 300)
```

```{r combined partial effects plot poster}
...
```{r environmental model comparison table}
...
save_as_docx(ft_env, path = "/Users/danportnof/Library/CloudStorage/SynologyDrive-Basilica/Dan\'s\ Files/SIO/0_capstone/6_figures/env_model_comparison_table.docx")
